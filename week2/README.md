...
This repository contains Python scripts developed during Week 2 of the biological computing bootcamp. The files cover the 
...
## Code Contents
- 'MyExampleScript.py' - Example basic script
